...
# -----------------------------
header_file_path <- "pageo2020.pl"
part1_file_path  <- "pa000012020.pl"
part2_file_path  <- "pa000022020.pl"
part3_file_path  <- "pa000032020.pl"
...
write.csv(combine, "PA_REDISTRICTING_DATA.csv", row.names = F)

alco <- subset(combine, COUNTY == '003')